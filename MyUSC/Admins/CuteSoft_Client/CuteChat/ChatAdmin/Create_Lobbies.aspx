...
alert('<%=_alertmsg%>');
						...
						<asp:DataGrid id="DataGrid1" DataKeyField="LobbyId" OnItemDataBound="DataGrid1_ItemDataBound"
							...
							BorderWidth="1px" BackColor="White" width="630" CellPadding="3" CellSpacing="0">
						...
						<br>
						<p align="center">
							<asp:Button id="ButtonAddNew" OnClick="ButtonAddNew_Click" runat="server" Text="Create a Chat Room"></asp:Button>
						</p>
					</td>
				</tr>
			</table>
