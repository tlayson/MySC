						...
						<table cellspacing="1" cellpadding="3" border="0" class="box">
							...
							<tr>
								<td valign=top class="boxArea">									
									...
									#FF00FF,#FFCC00,#FFFF00,#00FF00,#00FFFF,#00CCFF,#993366,#C0C0C0<br><br><br>
									<asp:TextBox ConfigName="ColorsArray" Runat="server" Width="500" ID="ColorsArray" TextMode="MultiLine" Rows="4"></asp:TextBox>
									<br>
