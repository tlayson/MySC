...
<script runat="server">
	...
	private void Page_Load(object sender, System.EventArgs e)
	{
		...
		temp += "<li><a href='###' onClick='Chat_OpenMessengerDialog()' >Messenger</a></li>";			
		temp += "<li><a href='../memberlist.aspx'>Member List</a></li>";	
		temp += "<li><a href='../whoisonline.aspx'>Who's Online</a></li>";
		
		// If user logged in, customize welcome message
		if (Request.IsAuthenticated == true) 
		{				
			if(IsAdministrator(this.Page.User.Identity.Name))
				temp += "<li><a href='UserAdmin.aspx'>Admin</a></li>";
		}	
