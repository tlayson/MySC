<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="MyUSC.Experiment.WebForm1" %>
...
<body>
    ...
    <div>
		...
		<asp:Panel ID="pnlTest" runat="server" CssClass="popupControl">
			...
			<ContentTemplate>
				<MSC:TBSCResponseDlg ID="TBSCRSVPDlg1" DlgTitle="Response" runat="server" EventID="1" OrgID="1" ResponseID="1" VenueID="1"></MSC:TBSCResponseDlg>
			</ContentTemplate>
			</asp:UpdatePanel>
		</asp:Panel>
	...
	<div>
        ...
        <div class="heading">
            <asp:ImageButton ID="Description_ToggleImage" runat="server" ImageUrl="~/Images/Button/MenuSelect.jpg" AlternateText="collapse" />
    ...
    <asp:Panel ID="Properties_HeaderPanel" runat="server" style="cursor: pointer;">
        <div class="heading">
            <asp:ImageButton ID="Properties_ToggleImage" runat="server" ImageUrl="~/Images/Button/MenuSelect.jpg" AlternateText="expand" />
