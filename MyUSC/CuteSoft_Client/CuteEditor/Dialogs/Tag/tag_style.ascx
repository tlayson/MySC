...
var OxO2e8e=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO2e8e[1],true)[OxO2e8e[0]]=function (){if(event[OxO2e8e[2]]){alert(element[OxO2e8e[3]].cssText);} ;} ;
</script>
