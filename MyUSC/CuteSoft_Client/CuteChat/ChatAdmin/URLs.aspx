							...
							<tr>
								<td valign=top class="boxArea">	
									<table cellSpacing="0" cellPadding="2" width="600" border="0">
										<tr bgcolor="#ffffff">
											<td>Login Url</td>
											<td><asp:TextBox ConfigName="LoginUrl" Runat="server" Width="200" ID="Textbox11"></asp:TextBox></td>
											<td>
										...
										<tr bgcolor="#f5f5f5">
											<td>Logout Url</td>
											<td><asp:TextBox ConfigName="LogoutUrl" Runat="server" Width="200" ID="Textbox12"></asp:TextBox></td>
											<td>
												For Example: "~/"
											</td>
										</tr>
										<tr bgcolor="#ffffff">
											<td>Logo Url</td>
											<td><asp:TextBox ConfigName="LogoUrl" Runat="server" Width="200" ID="Textbox13"></asp:TextBox></td>
											<td>
